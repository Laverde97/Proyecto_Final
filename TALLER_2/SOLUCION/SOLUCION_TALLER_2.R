...
#                                                                             #
###############################################################################
# ENCUESTA_5_a_14 <- read_excel("TALLER_2/Taller/ENCUESTA/BD_5 a 14.xlsx")
# SALUD_5_a_14 <- read_excel("TALLER_2/Taller/SALUD/BD_5 a 14.xlsx")
...
colnames(ENCUESTA_15_mas)<- c("Identificador","p6edad","p7sexo", "p14sgsss","p31usaamalgama","p32amalgamacasa",
                              "p33almacenahg","p34distancia","p35guardatoxicas" ,"p36manipulatoxicas",
                              "p37cercafumigaciones", "p38zonaproduccion")
...
Indica_Encuesta<- data.frame("I25"=Indi25,"I26"=Indi26,"I27"=Indi27,"I28"=Indi28,
                             "I29"=Indi29,"I30"=Indi30)
...
View(Adultos %>% 
       filter(p12cancerpulmon==1 | p13cancervejiga==1 | p14cancerpiel==1 | p15cancerriñon==1 |
...
Indica_Encuesta<-round(data.frame("I25"=Indi25,"I26"=Indi26,"I27"=Indi27,"I28"=Indi28,
                                  "I29"=Indi29,"I30"=Indi30),2);Indica_Encuesta
Indica_Salud<-round(data.frame("I35"=Indi35,"I36"=Indi36,"I37"=Indi37,"I37"=Indi38,
                               "I39"=Indi39),2);Indica_Salud
